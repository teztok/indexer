...
const EightbidCancelSwap8x8ColorEvent: TransactionHandler<EightbidCancelSwap24x24MonochromeEvent> = {
  source: 'transaction',
  ...
  exec: (transaction) => {
    ...
    const id = createEventId(EVENT_TYPE_8BID_24X24_MONOCHROME_CANCEL_SWAP, transaction);

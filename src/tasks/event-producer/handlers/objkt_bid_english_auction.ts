...
const ObjktBidEnglishAuctionHandler: TransactionHandler<ObjktBidEnglishAuctionEvent> = {
  source: 'transaction',
  ...
  exec: (transaction) => {
    ...
    const id = createEventId(EVENT_TYPE_OBJKT_BID_ENGLISH_AUCTION, transaction);
